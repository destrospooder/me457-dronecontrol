...
def f(t, y, u):
    ...
    # TODO what in God's good name is happening here
    return np.array([y[1], (1 / P.tau) * (P.K * u - y[0])])
...
for i in range(P.nsteps):
    ...
    u = controller.update(r, y.item(1))
    y = system.update(u)
    t += P.Ts
...
fig, ax = plt.subplots()
ax.plot(t_history, y_[:,1], label='Motor Position', color='orange')
